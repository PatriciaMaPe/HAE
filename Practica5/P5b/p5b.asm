...
;p5b.c,51 :: 		Lcd_Init();
	CALL        _Lcd_Init+0, 0
;p5b.c,54 :: 		INTCON2.RBPU = 0; // se habilitan las resistencias de pullup del puerto B
	BCF         INTCON2+0, 7 
;p5b.c,55 :: 		x = PORTB; //para poder borrar el RBIF
	MOVF        PORTB+0, 0 
	MOVWF       _x+0 
;p5b.c,56 :: 		INTCON.RBIF=0;
	BCF         INTCON+0, 0 
;p5b.c,57 :: 		INTCON.RBIE=1;
	BSF         INTCON+0, 3 
;p5b.c,58 :: 		INTCON.GIE = 1; // se habilitan las interrupciones en general
	BSF         INTCON+0, 7 
;p5b.c,60 :: 		uni=0;
	CLRF        _uni+0 
;p5b.c,61 :: 		dec=0;
